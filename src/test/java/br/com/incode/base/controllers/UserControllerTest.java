...
public class UserControllerTest {
    ...
    public void testDelete() {
        // Mock do resultado esperado
        Response response = new Response(true, "Excluido com sucesso!");
        when(userService.deleteById(1L, "Erro ao Deletar!")).thenReturn(response);

        // Chamada ao endpoint
        Response result = userController.delete(1L);
    ...
    public void testDelete_NonexistentUser() {
        ...
        Response response = new Response(false, "Usuário não encontrado");
        when(userService.deleteById(1L, "Erro ao Deletar!")).thenReturn(response);
